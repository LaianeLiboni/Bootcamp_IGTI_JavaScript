...
//push insere o elemnto no fim do array e retorna seu novo tamanho
...
//ataulizar elemento do indice informado
carros[2] = "Novo Uno";
//console.log(carros);
...
segundo paramentro: quantos elementos serao removidos a partir da posicao inicial
terceiro e demais parametros: elementos que serao inseridos a partir da posicao inicial
*/
carros.splice(2, 0, "Creta", "HB20");
//console.log(carros);
